 ...
 * @author etienne
 */
public class JSF32KochFractalFX extends Application {
    ...
    //private File file = new File("edgesUnbuffered");
    private int level = 1;
	...
	clearKochPanel();				
	KochManager km = new KochManager(this);	
	km.drawEdges();	
	...
	try {
	    ...
	    Logger.getLogger(JSF32KochFractalFX.class.getName()).log(Level.SEVERE, null, ex);
